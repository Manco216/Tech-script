...
async function cargarKpis() {
    try {
        const res = await fetch("/api/reportes/kpis");
...
async function cargarUsuariosCrecimiento() {
    try {
        const res = await fetch("/api/reportes/usuarios-crecimiento?meses=6");
        const data = await res.json();
...
async function cargarIngresosCategoria() {
    try {
        const res = await fetch("/api/reportes/ingresos-categoria");
        const data = await res.json();
...
async function cargarMetricasEngagement() {
    try {
        const res = await fetch("/api/reportes/metricas-engagement");
        const data = await res.json();
