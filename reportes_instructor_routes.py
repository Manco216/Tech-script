...
# PÁGINA PRINCIPAL
# ---------------------
@reportes_instructor_bp.route("/instructor/reportesIns")
@login_required
def reportes():
...
# ---------------------
@reportes_instructor_bp.route("/api/reportesIns/kpis")
@login_required
def reportes_kpis():
...
# ---------------------
@reportes_instructor_bp.route("/api/reportesIns/usuarios-crecimiento")
@login_required
...
# ---------------------
@reportes_instructor_bp.route("/api/reportesIns/ingresos-categoria")
@login_required
...
# ---------------------
@reportes_instructor_bp.route("/api/reportesIns/metricas-engagement")
@login_required
